...
const CardHomeProduct = (props) => {
  return (
    <div className="container grow p-4 flex flex-col justify-between bg-white">
      ...
      <div className="mt-2">
        <p className="text-[#040404] text-base font-semibold">
          {props.productTitle}Product Title
        </p>
        <p className="text-[#040404] text-base font-semibold ">
          {props.productPrice}$45
        </p>
        <div className="mt-4">
    ...
    <div className="container grow p-4 lg:p-14 flex flex-col lg:flex-row justify-center bg-white w-full">
      ...
      <div className="flex flex-col justify-between w-full mt-8 lg:mt-0">
        <div className="flex flex-col">
          <p className="text-[#040404] text-xl font-bold mb-1">
            {props.productTitle}{" "}
          </p>
          <p className="text-[#040404] text-xl font-bold mb-4">
            {props.productPrice}
          </p>
          <p className="text-[#040404] text-lg font-semibold">
            Deskripsi Produk
          </p>
          <p className="text-[#040404] text-base font-normal mb-8">
      ...
      <div className="flex flex-col lg:flex-row justify-between w-full">
        <div className="flex flex-col lg:flex-row w-full lg:w-2/3">
          ...
          <div className="flex flex-col ml-0 lg:ml-8 mt-4 lg:mt-0">
            <p className="text-[#040404] text-lg font-bold">
              {props.productTitle}Product Title
            </p>
            <p className="text-[#040404] text-lg font-bold">
              {props.productPrice}$45
      ...
      <div className="flex flex-col lg:flex-row p-2">
        ...
        <div className="flex flex-col justify-between ml-0 lg:ml-6">
          ...
          <div className="flex mt-8 lg:mt-0">
            ...
            <div className="mr-3">
              <Button
                onClick={props.onClickEditProduct}
                label={<FaPencilAlt />}
              ></Button>
            </div>
            <div>
              <Button
                onClick={props.onClickDelProduct}
                label={<FaTrash />}
              ></Button>
            </div>
          </div>
