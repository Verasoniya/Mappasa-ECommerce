          ...
          <div className="bg-[#F2F2F0] drop-shadow-md p-8 rounded-md font-semibold h-4/5">
            ...
            <div className="mb-4 font-normal">
              <Input
                ...
                id="input-fullName" /*value={email} onChange={(e) => setEmail({ email: e.target.value })}*/
              />
            </div>
            <div className="mb-4 font-normal">
              <Input
                type="email"
                placeholder="Email"
                id="input-email" /*value={email} onChange={(e) => setEmail({ email: e.target.value })}*/
              />
            </div>
            <div className="mb-4 font-normal">
              <Input
                ...
                id="input-password" /*value={email} onChange={(e) => setEmail({ email: e.target.value })}*/
              />
            </div>
            <div className="mb-4 font-normal">
              <Input
                type="text"
                placeholder="Telepon"
                id="input-telepon" /*value={email} onChange={(e) => setEmail({ email: e.target.value })}*/
              />
            </div>
            <div className="mb-12 font-normal">
              <Input
                type="text"
                placeholder="Alamat"
                id="input-alamat" /*value={password} onChange={(e) => setPassword({ password: e.target.value })}*/
              />
            </div>

            <Button
              label="Daftar" /*onClick={() => handleSubmit()} disabled={email.length === 0 || password.length === 0}*/
            />
          </div>
        </div>
      </div>
